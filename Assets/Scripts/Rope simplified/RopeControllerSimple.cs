...
public class RopeControllerSimple : MonoBehaviour 
{
    ...
    private void UpdateSpring()
    {
        ...
        float ropeForce = ropeMass * 4.81f;
        ...
        springJoint.spring = kRope * 1.5f;
        springJoint.damper = kRope * 1f;
